%w(Administrador Enfermera Vendedor Auxiliar_Estadística Administrador_Estadística Administrador_Farmacia Administrador_Enfermería Doctor Administrador_Fisiatría Fisiatra).each do |nombre|
